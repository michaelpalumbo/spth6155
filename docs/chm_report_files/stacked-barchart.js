	...
	return {
        ...
        newBars: function(root, uiConfig, xScale, yScale, idPostfix) {
			...
			it.onXScaleUpdate = function(updatedXScale) {
                ...
                if (dataStacked === undefined) return;
        ...
        newXBrush: function(root, uiConfig, xScale, height, yPosition) {
            ...
            uiConfig.visibleBars = uiConfig.visibleBars === undefined ? true : uiConfig.visibleBars;
            uiConfig.visibleLineSeries = uiConfig.visibleLineSeries === undefined ? false : uiConfig.visibleLineSeries;
